<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $hg = $_POST["hourly_charge"];

        do{
            if(empty($empNo) || empty($address) || empty($tel) || empty($working_status) || empty($hg)){
                $errorMessage = "All the fields are rquired";
                break;
            }


            // Add new attendent to database
            ...
            //--------------------------------
            $sql = "INSERT INTO attendent(empNo, hourly_charge)" .
                    "VALUES ($empNo, '$hg')";
            ...
            header("location: /Database%20Assignment/login/admin/attendent.php#about");
            exit;
...
<body>
    ...
    <section class="about section" id="about">
        <div class="container anmd" id="home">
            <h3 class="heading" style="font-size: 40px; margin-bottom: 90px;">Add Attendent</h3>
            ...
            <div class="container my-5">
                ...
                <form method="post">
                    ...
                    <div class="row mb-3">
                        <lable class="col-sm-3 col-form-lable">Hourly Charge</lable>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="hg" value="<?php echo $hg; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="offset-sm-3 col-sm-3 d-grid">
                            <a href="/Database%20Assignment/login/admin/attendent.php" class="btn btn-outline-primary">Back to list</a>
                        </div>
                    </div>
                </form>
            </div>
