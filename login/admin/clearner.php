    ...
    <section class="about section" id="about">
        <div class="container anmd" id="home">
            ...
            <div class="container my-5">
                            ...
                            while($row = $result->fetch_assoc()){
                                echo "
                                    <tr>
                                        ...
                                        <th>Cleaner</th>
                                        <td>
                                            <a href='/Database%20Assignment/login/admin/cleaner/edit.php?id=$row[empNo]' class='btn btn-primary btn-sm'>Edit</a>
                                            <a href='/Database%20Assignment/login/admin/cleaner/delete.php?id=$row[empNo]' class='btn btn-primary btn-sm'>Delete</a>
                                        </td>
                                    </tr>
                                ";
                            }
                ...
                <br />
                <br />
                <a href="/Database%20Assignment/login/admin/cleaner/create.php" class="btn btn-primary" role="button">New Cleaner</a>
