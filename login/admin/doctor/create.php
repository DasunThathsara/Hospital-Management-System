<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        do{
            ...
            //--------------------------------
            $sql = "INSERT INTO doctor(empNo, speciality, DEA)" .
                    "VALUES ($empNo, '$speciality', $DEA)";
            ...
            <div class="container my-5">
                ...
                <form method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="offset-sm-3 col-sm-3 d-grid">
                            <a href="/Database%20Assignment/login/admin/doctor.php" class="btn btn-outline-primary">Back to list</a>
                        </div>
                    </div>
                </form>
            </div>
