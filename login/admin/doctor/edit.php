<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        if(!isset($_GET["id"])){
            header("location: /Database%20Assignment/login/admin/doctor.php#about");
            exit;
        }
        ...
        $sql = "SELECT MCR, joined_date, resign_date, type FROM medical_employee WHERE empNo=$empNo";
        $result = $connection->query($sql);
        $row = $result->fetch_assoc();
        ...
        $sql = "SELECT speciality, DEA FROM doctor WHERE empNo=$empNo";
        $result = $connection->query($sql);
        $row = $result->fetch_assoc();
        ...
        do{
            ...
            //--------------------------------------------------
            $sql = "UPDATE doctor " .
                    "SET empNo = $empNo, speciality = '$speciality', DEA = '$DEA' " .
                    "WHERE empNo=$id";
            ...
            //--------------------------------------------------
            $sql = "UPDATE medical_employee " .
                    "SET empNo = $empNo, MCR = '$MCR', joined_date = '$joinned_date', resign_date = '$resign_date', type = '$type' " .
                    "WHERE empNo=$id";
            ...
            //--------------------------------------------------
            $sql = "UPDATE doctor " .
                    "SET empNo = $empNo, name = '$name', addresss = '$address', tel = '$tel', working_status = '$working_status' " .
                    "WHERE empNo=$id";
        ...
        <div class="container anmd" id="home">
            ...
            <div class="container my-5">
                ...
                <form method="post">
                    ...
                    <div class="row mb-3">
                        <lable class="col-sm-3 col-form-lable">speciality</lable>
                        <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        <lable class="col-sm-3 col-form-lable">DEA</lable>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="DEA" value="<?php echo $DEA; ?>" />
                        </div>
                    </div>
