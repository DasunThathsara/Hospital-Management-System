    ...
    <section class="about section" id="about">
        <div class="container anmd" id="home">
            ...
            <div class="container my-5">
                            ...
                            while($row = $result->fetch_assoc()){
                                echo "
                                    <tr>
                                        ...
                                        <th>Nurse</th>
                                        <td>
                                            <a href='/Database%20Assignment/login/admin/nurse/edit.php?id=$row[empNo]' class='btn btn-primary btn-sm'>Edit</a>
                                            <a href='/Database%20Assignment/login/admin/nurse/delete.php?id=$row[empNo]' class='btn btn-primary btn-sm'>Delete</a>
                                        </td>
                                    </tr>
                                ";
                            }
                ...
                <br />
                <br />
                <a href="/Database%20Assignment/login/admin/nurse/create.php" class="btn btn-primary" role="button">New Doctor</a>
