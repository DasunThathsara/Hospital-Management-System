                            ...
                            while($row = $result->fetch_assoc()){
                                echo "
                                    <tr>
                                        ...
                                        <td>$row[tel]</td>
                                        <td>
                                            <a href='/Database%20Assignment/login/admin/vendor/edit.php?regNo=$row[regNo]' class='btn btn-primary btn-sm'>Edit</a>
                                            <a href='/Database%20Assignment/login/admin/vendor/delete.php?regNo=$row[regNo]' class='btn btn-primary btn-sm'>Delete</a>
                                        </td>
                                    </tr>
                                ";
                            }
