...
<?php
    ...
    if(isset($_POST['login'])){
        ...
        if($name == "doctor" && $password == 1234){
            header("location: /Database%20Assignment/login/users/doctor/dashboard.php");
            exit;
        }
        else{
...
<body>
    <section class="showcase-area container-fluid full" id="home">
        <div class="container anmd" id="home">
            <h3 class="heading" style="font-size: 40px; margin-bottom: 90px;">Doctor Login</h3>
